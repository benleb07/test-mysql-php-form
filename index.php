     ...
     <body>
        <div id="banner1">
     	...
     	<div class="contenuprincipal">
            ...
            <img class="photo_id" src="icone_id.jpg" alt="" height="250px" width="200px"/>
     		<p class="prenom">Benjamin</p><br/>

     		<p class="nom">LEBON</p><br/>

            <p class="poste">Développeur Web et Mobile</p><br/>
            <fieldset class="f_coor">
                 <legend class="f_leg">Mes Coordonnées !</legend>

                 <img class="img_adresse" src="adresse.png" alt="" height="25px" width="25px"/><p class="p_adresse">3 Avenue Général Gilles</p><br/>

                 <img class="img_mail" src="mail.png" alt="" height="25px" width="25px"/><p class="p_mail">benjamin.lebon07@gmail.com</p><br/>

                 <img class="img_phone" src="phone.jpg" alt="" height="25px" width="25px"/><p class="p_phone">06.03.65.23.52</p>

            </fieldset>

            <p class="p_profil">Iste quidem veteres inter ponetur honeste, qui vel mense brevi vel toto est iunior anno. Utor permisso, caudaeque pilos ut equinae paulatim vello unum, demo etiam unum, dum cadat elusus ratione ruentis acervi, qui redit in fastos et annis miraturque.
